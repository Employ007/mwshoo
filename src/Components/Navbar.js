...
export default function Navbar() {
  return (
                        ...
                        <div className="profilecard">
                            <div className='pcard'>
                               ...
                               <p>To access your Meesho account</p>
                                <div> <button className='botton' > <a href="/signup" className='botton' >Sign up</a>     </button></div>
    ...
    <div className="main2">
    <div className="innerext">

    <div className="inner1">Women Ethnic  <hr className='hr' /> 
    <div className="maintable">

<div className="col">
    <div className="colhead">All Women Ethnic</div>
    <div className="innercol">View All</div>
    <div className="innercol">Women Styles</div>
</div>
<div className="col2">
    <div className="colhead">Sarees</div>
    <div className="innercol">All Sarees</div>
    <div className="innercol">Silk Sarees</div>
</div>
<div className="col3">
    <div className="colhead">Kurtis</div>
    <div className="innercol">All Kurtis</div>
    <div className="innercol">Anarkali Kurtis</div>
</div>
<div className="col4">
    <div className="colhead">Kurta Sets</div>
    <div className="innercol">All Kurta Sets</div>
    <div className="innercol">Rayon Kurta</div>
</div>
<div className="col5">
    <div className="colhead">Suits & Dress Material</div>
    <div className="innercol">All Suits & Dress Material</div>
    <div className="innercol">Cotton Suits</div>
</div>
    ...
    <div className="inner1" >Women Western  <hr className='hr' />
    <div className="maintable">
...
<div className="col5">
    ...
    <div className="inner1" id='men'>Men  <hr className='hr' /> 
  
 </div>
    <div className="inner1">Kids  <hr className='hr' /> 
    
</div>
    <div className="inner1">Beauty & health  
    <hr className='hr' />
     </div>
    <div className="inner1">Jewellery & Accessories  <hr className='hr' /> </div>
    <div className="inner1">Bags & Footwear  <hr className='hr' /> </div>
    <div className="inner1">Electronics  <hr className='hr' /> </div>
