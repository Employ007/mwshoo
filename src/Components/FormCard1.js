...
<div className='divsv3' id='divo' ><RiArrowDropDownLine id='sv2' /></div>
                ...
                <div className="cont">
                    <div className="check"><input type='checkbox' checked /></div>
        ...
        <div className="cards">
        <div className="carda">
            <div className='card1img'><img src="https://images.meesho.com/images/products/69993560/ufpln_400.webp" alt="" /></div>
            <div className='card1'>
            ...
            <div className='card1img'><img src="https://images.meesho.com/images/products/228185109/uen9g_400.webp" alt="" /></div>
            <div className='card1'>
                <div className='headi'>New Collections of face ...</div>
                <div className='flexi'>
                    <div className='bold'>Rs:175</div>
            ...
            <div className='card1img'><img src="https://images.meesho.com/images/products/144670259/hvnms_400.webp" alt="" /></div>
            <div className='card1'>
                <div className='headi'>New Collections of face ...</div>
                <div className='flexi'>
                    <div className='bold'>Rs:175</div>
            ...
            <div className='card1img'><img src="https://images.meesho.com/images/products/80342629/h69mg_400.webp" alt="" /></div>
            <div className='card1'>
                <div className='headi'>New Collections of face ...</div>
                <div className='flexi'>
                    <div className='bold'>Rs:175</div>
