...
<div className='divsv3' id='divo' ><RiArrowDropDownLine id='sv2' /></div>
        ...
        <div className="cards">
        <div className="carda">
            <div className='card1img'><img src="https://images.meesho.com/images/products/223256299/uior9_400.webp" alt="" /></div>
            <div className='card1'>
            ...
            <div className='card1img'><img src="https://images.meesho.com/images/products/211408864/gq43s_400.webp" alt="" /></div>
            <div className='card1'>
                <div className='headi'>New Collections of face ...</div>
                <div className='flexi'>
                    <div className='bold'>Rs:175</div>
